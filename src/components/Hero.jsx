    ...
    <header className="hero" id="hero">
      ...
      <div className="hero-content">
        ...
        <div className="hero-cta">
          <a
            href="#shop"
            className="inline-flex items-center justify-center px-8 py-3.5 text-sm font-semibold bg-btn text-bg-primary rounded hover:bg-accent-hover hover:-translate-y-0.5 hover:shadow-lg transition-all duration-300"
